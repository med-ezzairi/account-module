            ...
            <div class="row">
                <div class="radio-btn clearfix">
                    ...
                    <div class="radio">
                        ...
                        <label for="{{ "{$group}-{$permissionAction}" }}-inherit">{{ $inherit }}</label>
                    </div>
                    ...
                    <div class="radio">
                        ...
                        <label for="{{ "{$group}-{$permissionAction}" }}-deny">{{ $deny }}</label>
                    </div>
                    ...
                    <div class="radio">
                        ...
                        <label for="{{ "{$group}-{$permissionAction}" }}-allow">{{ $allow }}</label>
                    </div>
                </div>
            </div>
        </div>
